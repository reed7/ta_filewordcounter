...
public class TestUtils {
    ...
    public void testProcessIncResult() {
        ...
        List<WordCountResult> ret = Utils.getTopNWords(resultMap, 4, "inc");
    ...
    public void testProcessDecResult() {
        ...
        List<WordCountResult> ret = Utils.getTopNWords(resultMap, 4, "dec");
    ...
    public void testProcessTopNMoreThanResult() {
        ...
        List<WordCountResult> ret = Utils.getTopNWords(resultMap, 9, "inc");
    ...
    public void testProcessTopZeroOrLess() {
        ...
        List<WordCountResult> ret = Utils.getTopNWords(resultMap, -1, "inc");
